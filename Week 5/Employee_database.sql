...
Create table INCENTIVES(EMPNO int, INCENTIVE_DATE date, INCENTIVE_AMOUNT int,primary key(EMPNO,INCENTIVE_DATE),foreign key(EMPNO) references EMPLOYEE(EMPNO));
Create table ASSIGNED_TO(EMPNO int,PNO int, JOB_ROLE varchar(20),primary key(EMPNO,PNO),foreign key(EMPNO) references EMPLOYEE(EMPNO),
...
INSERT INTO INCENTIVES (EMPNO, INCENTIVE_DATE, INCENTIVE_AMOUNT) VALUES (7001, '2023-04-01', 2500);
INSERT INTO INCENTIVES (EMPNO, INCENTIVE_DATE, INCENTIVE_AMOUNT) VALUES (7002, '2023-05-01', 3000);
